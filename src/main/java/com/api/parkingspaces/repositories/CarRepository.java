...
public interface CarRepository extends JpaRepository<CarModel, Long>{
	...
	@Query(nativeQuery = true, value = "SELECT par.parking_spot_numbera AS parkingSpotNumberA, par.parking_spot_numberb AS parkingSpotNumberB, res.block AS nameBlock, res.apartment AS nameApartment , car.model_car AS ModelCar, car.license_plate_car AS licenseCar, res.first_name AS firstName, res.last_name AS lastName "
			+ "FROM tb_car car "
